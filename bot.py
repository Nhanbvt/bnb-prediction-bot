Hiểu rồi! Xem 3 tx:
	...
	1.	Bet thủ công: 0.00063 BNB gas
	2.	Claim thủ công: 0.000063 BNB gas
	3.	Bet auto code: 0.001+ BNB gas (quá cao!)

Sửa lại - dùng eth_estimateGas để tính gas tối ưu:

Xóa bot.py → tạo lại (chỉ sửa 2 hàm):
